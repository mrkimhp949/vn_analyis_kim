...
class CircuitBreaker:
    ...
    def can_trade(self) -> Tuple[bool, str]:
        ...
        if today_stats['total_loss'] >= max_loss:
            ...
            return False, f"🚫 Max loss per day reached ({loss_pct:.2f}% >= {self.max_loss_per_day_pct*100:.1f}%)"
    ...
    def get_status_message(self) -> str:
        ...
        msg.append(f"⚠️ Consecutive losses: {self.stats['consecutive_losses']}/{self.max_consecutive_losses}")
        msg.append("")
