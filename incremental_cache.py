...
class IncrementalCache:
    ...
    def update_cache(
        ...
        for date in dates:
            date_df = new_data[new_data.get('date', '') == date].copy() if 'date' in new_data.columns else new_data
        ...
        self.metadata[symbol_key]['cached_dates'] = sorted(list(set(
            self.metadata[symbol_key].get('cached_dates', []) + dates
        )))
