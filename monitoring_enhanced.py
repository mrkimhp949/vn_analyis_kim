...
portfolio_value = Gauge(
    ...
    'Current portfolio value in VND'
)

portfolio_pnl = Gauge(
    'trading_portfolio_pnl',
    'Current portfolio P&L in VND'
)

portfolio_pnl_percent = Gauge(
    'trading_portfolio_pnl_percent',
    'Current portfolio P&L percentage'
)
...
class EnhancedMonitor:
    ...
    def get_health_status(self) -> Dict:
        ...
        return {
            ...
            'checks': {
                'scan_recent': scan_healthy,
                'no_recent_errors': error_healthy
            }
        }
