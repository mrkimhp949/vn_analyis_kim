        ...
        for symbol, pos in positions.items():
            try:
                manager.add_position(
                    ...
                    take_profit=pos.get('take_profit_targets', [None])[0] if pos.get('take_profit_targets') else None,
                    metadata=pos
                )
                count += 1
...
def main():
    ...
    print("   python -c 'from portfolio_manager import get_portfolio_manager; print(get_portfolio_manager().get_detailed_analysis())'")
    print("")
