...
# Trading signals
signals_generated = Counter('signals_generated_total', 'Total trading signals generated', ['signal_type'])
signals_confidence = Histogram('signal_confidence', 'Signal confidence distribution', buckets=[50, 60, 70, 80, 90, 100])

# Trades
trades_executed = Counter('trades_executed_total', 'Total trades executed', ['action'])
trade_pnl = Histogram('trade_pnl', 'Trade P&L distribution', buckets=[-1000000, -500000, 0, 500000, 1000000, 2000000])
